...
| Preview | https://valor-train-fbenlw3jq-vegan-demons-projects.vercel.app | Vercel preview, Omar's account. Not a Valor domain. Long-term host should be Netlify next to the site (`netlify.toml` is in the folder). |
